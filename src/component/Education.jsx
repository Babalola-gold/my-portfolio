            ...
            <section data-aos="flip-down" className="aos-init aos-animate">
                ...
                <div className="text-gray-600 lg:flex my-5 text-center">
                    <div id="edu" className="mx-auto rounded bg-white">
                        {/* <img className="img-fluid mx-auto lg:mt-5 mt-5 mb-2" width="50" src="/image/sqi.png" alt="" /> */}
                    ...
                    <div id="edu" className="mx-auto rounded bg-white">
                        {/* <img className="img-fluid mx-auto lg:mt-5 mt-5 mb-2" width="50" src="/image/lautech.png" alt="" /> */}
